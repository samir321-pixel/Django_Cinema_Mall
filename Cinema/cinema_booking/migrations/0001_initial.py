# Generated by Django 3.1.7 on 2021-03-02 15:30
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slot', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='managecinema.cinemaarrangeslot')),
            ],
        ),
        migrations.CreateModel(
            name='seat_manager',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('book_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
                ('deck', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='managecinema.cinemadeck')),
                ('seat', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='cinema_booking.seat_manager')),
            ],
        ),
        migrations.CreateModel(
            name='BookSeat',
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now=True)),
                ('updated_at', models.DateTimeField(auto_now_add=True)),
                ('seat', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='cinema_booking.seat')),
