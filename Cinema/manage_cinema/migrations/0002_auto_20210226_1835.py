# Generated by Django 3.1.7 on 2021-02-26 13:05
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now=True)),
                ('active', models.BooleanField(default=True)),
                ('deck', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='manage_cinema.cinema_deck')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('active', models.BooleanField(default=True)),
                ('cinema', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='manage_cinema.cinema')),
                ('duration', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='manage_cinema.cinemaslotsduration')),
            ],
        ),
    ]
